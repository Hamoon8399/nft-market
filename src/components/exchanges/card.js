...
export default class Card extends Component {
  render() {
    ...
    return (
      <Col md={3} className="card-nft-container">
        <div className="card-nft">
          ...
          >
            <div className="value-nft-container">
              {nft.sale == "0" ? (
                <>
                  <span style={{ color: "#4a4a4a", marginRight: "10px" }}>
                    {nft.value}
                  </span>
                  <svg
                    width="24"
            ...
            <img src={url} className="avatar-nft" />
          </div>
          <div>
            <div className="avatar-user-container">
              <div className="avatar-user">
                {nft.owner.slice(0, 1).toUpperCase()}
              </div>
            </div>
            ...
            <div className="name-user-container">
              ...
              <span
                className="name-user"
                onClick={() => {
                  this.props.redirectProfile({ accountId: owner });
                }}
              >
                {owner}
              </span>
